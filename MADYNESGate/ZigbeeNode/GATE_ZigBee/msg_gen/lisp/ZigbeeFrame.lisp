...
(cl:defmethod cl:initialize-instance :after ((m <ZigbeeFrame>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ZigbeeFrame)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name GATE_ZigBee-msg:<ZigbeeFrame> is deprecated: use GATE_ZigBee-msg:ZigbeeFrame instead.")))
